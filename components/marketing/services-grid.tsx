...
const SERVICES = [
  ...
  },
  {
    ...
    photo: "https://images.pexels.com/photos/16848596/pexels-photo-16848596.jpeg?auto=compress&cs=tinysrgb&w=800",
    photoAlt: "Unité extérieure de climatisation split murale",
    accentClass: "bg-brand-50 border-brand-100 group-hover:border-brand-200",
    iconClass: "bg-brand-100 text-brand-700",
  },
  {
